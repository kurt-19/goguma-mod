...
class IsolateHolderService : Service() {
    ...
    override fun onTaskRemoved(rootIntent: Intent) {
        ...
        // Keep the Flutter isolate alive when the Android task is swiped away.
        // Goguma's IRC socket lives in Dart, so stopping this service here
        // makes the server close the nickname even though the foreground
        // notification and radio service are still visible.
    }
}
